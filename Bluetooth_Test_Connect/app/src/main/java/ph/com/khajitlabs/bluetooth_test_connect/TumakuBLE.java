...
/**
 * Created by Allen on 17/05/2018.
 */
...
public class TumakuBLE {
    /** HM10 Details **/
    public static final String SENSORTAG_KEY_SERVICE = "0000ffe0-0000-1000-8000-00805f9b34fb"; //custom HC10 service UUID
    public static final String SENSORTAG_KEY_DATA = "0000ffe1-0000-1000-8000-00805f9b34fb"; //custom HC10 characteristic UUID
    ...
    public void enableNotifications(String serviceUUID, String characteristicUUID, boolean notificationFlag) {
        ...
        if(characteristic!=null){
            ...
            mGatt.setCharacteristicNotification(characteristic, notificationFlag); //Enabled locally
              config = characteristic.getDescriptor(CCC);
            if (notificationFlag) {
    ...
    public class MyCallBack extends BluetoothGattCallback {
        ...
        public void onCharacteristicChanged(BluetoothGatt gatt,
            ...
            if(Constant.DEBUG){
                Log.i("JMG", "NOTIFICATION onCharacteristicChanged for characteristic " + characteristic.getUuid().toString() +
